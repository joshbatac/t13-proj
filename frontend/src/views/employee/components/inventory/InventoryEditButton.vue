<template>
    <div class="popup">
      ...
      <div class="popup-content">
        ...
        <div>
          ...
          <hr>
          <button @click="addItem" :disabled="newItem.currentStorage > newItem.maxStorage || newItem.maxStorage == 0 || newItem.price == 0 || name == ''" 
            class="confirm-button">Add to Inventory</button> <button @click="$emit('cancel')" class="cancel-button">Exit</button>
  ...
  export default {
    ...
    methods: {
      ...
      async addItem() {
        // Add the new item to the database and update the inventory
        await axios.post('http://localhost:3000/inventory', this.newItem);
        this.fetchInventory();
      ...
      async removeItem(itemId) {
        // Remove the item from the database and update the inventory
